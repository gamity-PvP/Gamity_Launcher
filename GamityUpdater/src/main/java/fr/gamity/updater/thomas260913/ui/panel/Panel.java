...
import fr.gamity.updater.thomas260913.ui.panel.IMovable;
import fr.gamity.updater.thomas260913.ui.panel.IPanel;
import fr.gamity.updater.thomas260913.ui.panel.ITakePLace;
...
public abstract class Panel implements IPanel, IMovable, ITakePLace {
    ...
    public Panel() {
        this.logger = Updater.getInstance().getLogger();
    }
