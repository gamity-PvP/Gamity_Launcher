...
set CLASSPATH=%APP_HOME%\lib\GamityUpdater-1.1-all.jar

@rem Execute GamityUpdater
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %GAMITY_UPDATER_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%GAMITY_UPDATER_EXIT_CONSOLE%" exit 1
exit /b 1
