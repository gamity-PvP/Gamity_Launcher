...
public class JsonCreator {
    ...
    public void showModrinthModPackJsonCreator() {
        ...
        TextField versionId = new TextField("versionId");
        TextField versionNumber = new TextField("versionNumber");
        TextField projectReference = new TextField("projectReference");
        CheckBox extFiles = new CheckBox("fichier externe");
        TextField excludedMods = new TextField("mods exclu");
        Button saveBtn = new Button("Enregistrer");
        versionId.setMaxWidth(300);
        versionNumber.setMaxWidth(300);
        projectReference.setMaxWidth(300);
    ...
    public void showCurseModPackJsonCreator() {
        ...
        TextField fileId = new TextField("fileId");
        TextField projectId = new TextField("projectId");
        CheckBox extFiles = new CheckBox("fichier externe");
        TextField excludedMods = new TextField("mods exclu");
        Button saveBtn = new Button("Enregistrer");
        fileId.setMaxWidth(300);
